    ...
    <v-card>
      <v-row no-gutters>
        ...
        <v-col cols="12" class="pa-2 pt-3">
          <DeleteProfessionRateDialog :item="item" v-on:deleteItem="onDeleteItem" />
          <v-btn
            text
            color="success"
            class="float-right"
...
import DeleteProfessionRateDialog from '../delete/DeleteProfessionRateDialog.vue';

@Component({
  components: {
    DeleteProfessionRateDialog
  }
})
export default class EditProfessionItem extends Vue {
