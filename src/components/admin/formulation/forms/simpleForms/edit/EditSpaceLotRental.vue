    ...
    <v-card>
      <v-row no-gutters>
        ...
        <v-col cols="12" class="pa-2 pt-3">
          <DeleteSpaceLotRentalDialog :item="item" v-on:deleteItem="onDeleteItem" />
          <v-btn
            text
            color="success"
            class="float-right"
...
import DeleteSpaceLotRentalDialog from '../delete/DeleteSpaceLotRentalDialog.vue';

@Component({
  components: { DeleteSpaceLotRentalDialog }
})
export default class EditSpaceLotRental extends Vue {
