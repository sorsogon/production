    ...
    <v-card>
      <v-row no-gutters>
        ...
        <v-col cols="12" class="pa-2 pt-3">
          <DeleteVehicleDialog :item="item" v-on:deleteItem="onDeleteItem" />
          <v-btn
            text
            color="success"
            class="float-right"
...
import DeleteVehicleDialog from '../delete/DeleteVehicleDialog.vue';
...
export default class EditVehicleType extends Vue {
